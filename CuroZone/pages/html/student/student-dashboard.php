...
?>
	...
	<body>
		...
		<div class="mainframe">
			<div class="welcome">
				<?php
				$get_name = "SELECT first_name FROM student_tbl WHERE student_id = '" . $_SESSION['memberid'] . "'";
				$result = mysqli_query($con, $get_name);
				while ($row = $result->fetch_assoc()) {
					echo "<h2>Hi " . $row['first_name'] . "!</h2>";
				}
				?>
					...
					<tbody>
						<tr>
							...
							<td style="padding: 0vw 0vw 0vw 5vw; text-align:left; line-height: 2.5vw; font-size: 18px;">
								<b>Welcome to CuroZone!</b><br>
								In here, you can,<br>
								pay your course fees and check your payment status,<br>
								view graduation scheedule,<br>
								get exam schedules and admissions,<br>
								get assignment schedules, assignments and submit them,<br>
								get class schedules,<br>
								view results,<br>
								view course modules,<br>
								get course materials and get course guidelines,<br>
								view noticeboard,<br>
								message with coordinator and lecturers,<br>
								view contact details<br>
								and<br>
								send feedbacks to coordinators.<br>
							</td>
						</tr>
					</tbody>
				</table>
