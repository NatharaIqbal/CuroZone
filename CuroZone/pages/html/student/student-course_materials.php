	...
	<body>
		...
		<div class="side-bar">
			...
			<div class="menu">
				...
				<div class="item"><a id="active-item"><i class="fas fa-book"></i>Course Materials</a></div>
		...
		<div class="mainframe">
			<div class="welcome">
				<h2 style="text-align: center; padding: 5px;">Course Materials</h2>
				...
				<tbody>
					<tr>
						<td style="text-align: center"><label for="select">Module : </label><select name="moduleselect" id="moduleselect">
								...
								<?php
								$sql = "SELECT * FROM module_tbl WHERE course_id = '" . $_SESSION['course_id'] . "'";
	...
	<script>
		$(document).ready(function() {
			$('#moduleselect').on('change', function() {
				...
				$.ajax({
					url: "/pages/html/student/student-filter_course_material.php",
					type: "POST",
