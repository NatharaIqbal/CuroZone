...
?>
	...
	<head>
		<meta charset="utf-8">
		<title>Call Center - CuroZone</title>
	...
	<body>
		...
		<div class="side-bar">
			...
			<div class="menu">
				...
				<div class="item"><a id="active-item"><i class="fas fa-phone"></i>Call Center</a></div>
		...
		<div class="mainframe">
			<div class="welcome">
				<h2 style="text-align: center; padding: 5px;">Call Center</h2>
						...
						<tbody>
							<tr>
								...
								<td style="text-align: left;">
									<b>Curo Institute, Colombo,<br>Sri Lanka</b>
								</td>
							</tr>
							<tr>
								<td width="25%">
