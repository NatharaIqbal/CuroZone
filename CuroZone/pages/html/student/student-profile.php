            ...
            <div class="under_development">
                <table class="profile" width="70%">
                    <tbody>
                        ...
                        <tr>
                            <td width=30% style="text-align:right; font-weight: bold;">Student ID :</td>
                            <td style="text-align:left;"><?php echo strtoupper($row['student_id']); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <?php
                            $sql2 = "SELECT * FROM course_tbl WHERE course_id='" . $_SESSION['course_id'] . "'";
                            $result2 = mysqli_query($con, $sql2);
                            $row2 = mysqli_fetch_assoc($result2);
                            ?>
                            <td style="text-align:left;"><?php echo "$row2[course_name]"; ?></td>
                        </tr>
                        <tr>
                            <td style="text-align: right; font-weight: bold;">Batch :</td>
                            <td style="text-align:left;"><?php echo "$row[batch_id]"; ?></td>
                        </tr>
                        <tr>
