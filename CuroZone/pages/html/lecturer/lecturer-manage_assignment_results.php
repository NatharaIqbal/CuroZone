...
?>
	...
	<body>
			...
			<div class="menu">
				...
				<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-line-chart"></i>Results
					...
					<div class="sub-menu">
						...
						<a id="active-item" class="sub-item">Manage Assignment Results</a>
		...
		<div class="mainframe">
			<div class="welcome">
				<h2 style="text-align: center; padding: 5px;">Manage Assignment Results</h2>
	...
	<script>
		$(document).ready(function() {
			$('#batchselect').on('change', function() {
				...
				console.log(batch_id);
				$.ajax({
					url: "lecturer-filter_assignment_results.php",
					type: "POST",
					data: '&batch_id=' + batch_id + '&assignment_id=' + assignment_id,
					beforeSend: function() {
