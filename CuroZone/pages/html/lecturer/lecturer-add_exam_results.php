...
?>
	...
	<body>
			...
			<div class="menu">
				...
				<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-line-chart"></i>Results
					...
					<div class="sub-menu">
						...
						<a id="active-item" class="sub-item">Add Exam Results</a>
		...
		<div class="mainframe">
			<div class="welcome">
				<h2 style="text-align: center; padding: 5px;">Add Exam Results</h2>
				<hr style="width: 50%; margin:auto;">
				<hr style="width: 50%; margin:auto;">
			</div>
			<div class="task">
				<form id="form1" name="form1" method="post" action="lecturer-add_exam_results_check.php">
