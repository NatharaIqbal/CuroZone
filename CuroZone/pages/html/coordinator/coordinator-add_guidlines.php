...
<head>
	<meta charset="utf-8">
	<title>Add Cource Guidlines - CuroZone</title>
...
<div class="topbar">
	...
	<div class="side-bar">
		...
		<div class="menu">
			...
			<div class="item"><a href="coordinator-course_materials.php"><i class="fas fa-book"></i>Course
					Materials</a></div>
			<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-bars"></i>Course Guidlines
					<i class="fas fa-angle-right dropdown"></i>
				</a>
				<div class="sub-menu">
					<a id="active-item" class="sub-item">Add Guidlines </a>
	...
	<div class="mainframe">
		<div class="welcome">
			<h2 style="text-align: center; padding: 5px;">Add Cource Guidlines</h2>
			<hr style="width: 50%; margin:auto;">
			<hr style="width: 50%; margin:auto;">
		</div>
		<?php include('dbconnect.php'); ?>
		<div class="task">
			<form id="form1" name="form1" method="post" action="coordinator-add_guidlines_check.php"   enctype="multipart/form-data">
				<table width="40%">
					<tbody>
						<tr>
						...
						<tr>
							<td style="text-align: right"><label for="date2">Guidlines</label></td>
							<td style="text-align: center">:</td>
