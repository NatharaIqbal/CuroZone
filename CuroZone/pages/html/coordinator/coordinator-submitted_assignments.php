...
<head>
	<meta charset="utf-8">
	<title>Submitted Assignments - CuroZone</title>
...
<div class="topbar">
		...
		<div class="menu">
			...
			<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-code"></i>Assignments
				...
				<div class="sub-menu">
					...
					<a id="active-item" class="sub-item">Submitted Assignments</a>
				</div>
			</div>
	...
	<div class="mainframe">
		<div class="welcome">
			<h2 style="text-align: center; padding: 5px;">Submitted Assignments</h2>
				...
				<table class="searchtbl">
					<tbody>
						<tr>
							...
							<td style="text-align: right"><label for="select">Module : </label></td>
	...
	<script>
		$(document).ready(function() {
			$('#batchselect').on('change', function() {
				...
				var module_id = 'null';
				$.ajax({
					url: "/pages/html/common/common-filter_submitted_assignment.php",
					type: "POST",
