		...
		<div class="side-bar">
			...
			<div class="menu">
				...
				<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-line-chart"></i>Results
					...
					<div class="sub-menu">
						<a class="sub-item" id="active-item">Assignment Results</a>
				...
				<form id="form1" name="form1" method="post">
					<table width="40%" class="searchtbl">
						...
						<tr>
							...
							<tr>
								<td style="text-align: right"><label for="select4">Student ID : </label></td>
		...
		<script>
			$(document).ready(function() {
				$('#batchselect').on('change', function() {
					...
					$.ajax({
						url: "coordinator-filter_assignment_result.php",
						type: "POST",
						data: '&request1=' + batch_id + '&request2=' + student_id + '&request3=' + module_id,
						beforeSend: function() {
