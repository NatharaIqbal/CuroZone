...
<head>
	<meta charset="utf-8">
	<title>Manage Guidlines - CuroZone</title>
...
<div class="topbar">
		...
		<div class="menu">
			...
			<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-bars"></i>Course Guidlines
				...
				<div class="sub-menu">
					...
					<a id="active-item" class="sub-item">Manage Guidlines</a>
				</div>
			</div>
	...
	<div class="mainframe">
		<div class="welcome">
			<h2 style="text-align: center; padding: 5px;">Manage Guidlines</h2>
			<hr style="width: 50%; margin:auto;">
			<hr style="width: 50%; margin:auto;">
		
				<table width="100%"  class="searchtbl">
					<tbody>
						<tr>
