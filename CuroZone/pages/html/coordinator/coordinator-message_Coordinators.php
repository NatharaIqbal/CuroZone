		...
		<div class="side-bar">
			...
			<div class="menu">
				...
				<div class="item"><a class="sub-btn"><i class="fas fa-users"></i>Students
					...
					<div class="sub-menu">
						<a href="coordinator-view_students.php" class="sub-item">View Students</a>
				...
				<div class="item"><a class="sub-btn"><i class="fas fa-address-card"></i>Batches
					...
					<div class="sub-menu">
						...
						<a href="coordinator-view_batches.php" class="sub-item">View Batches</a>
				...
				<div class="item"><a class="sub-btn"><i class="fas fa-pencil"></i>Exams
					...
					<div class="sub-menu">
						...
						<a href="coordinator-view_exam_admissions.php" class="sub-item">View Exam Admissions</a>
				...
				<div class="item"><a class="sub-btn"><i class="fas fa-bars"></i>Course Guidlines
					...
					<div class="sub-menu">
						<a href="coordinator-view_guidlines.php" class="sub-item">View Guidlines </a>
				...
				<div class="item"><a class="sub-btn"><i class="fas fa-code"></i>Noticeboard
					...
					<div class="sub-menu">
						<a href="coordinator-view_noticeboard.php" class="sub-item">View Noticeboard</a>
						<a href="coordinator-add_notices.php" class="sub-item">Add Notices</a>
						<a href="coordinator-manage_noticeboard.php" class="sub-item">Manage Noticeboard</a>
					</div>
				</div>
				<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-commenting"></i>Messages
					...
					<div class="sub-menu">
						...
						<a  id="active-item"class="sub-item">Coordinators</a>
