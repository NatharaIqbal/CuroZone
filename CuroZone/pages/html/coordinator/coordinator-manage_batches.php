			...
			<div class="menu">
				...
				<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-address-card"></i>Batches
					...
					<div class="sub-menu">
						...
						<a class="sub-item" id="active-item">Manage Batches</a>
					</div>
				</div>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<?php echo "<form id='form1' name='form1' method='post' action='coordinator-edit_batches.php?batch_id=$batch_id'>" ?>
		...
		<script>
			$(document).ready(function() {
				$('#courseselect').on('change', function() {
					...
					$.ajax({
						url: "/pages/html/common/common-sort_batch.php",
						type: "POST",
