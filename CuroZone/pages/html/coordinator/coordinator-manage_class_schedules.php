...
?>
	...
	<head>
		<meta charset="utf-8">
		<title>Manage Class Schedules - CuroZone</title>
			...
			<div class="menu">
				...
				<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-calendar"></i>Class Schedules
					...
					<div class="sub-menu">
						...
						<a id="active-item" class="sub-item">Manage Class Schedules</a>
					</div>
				</div>
			...
			<div class="welcome">
				...
				<form id="form1" name="form1" method="post">
					<table class="searchtbl">
						<tbody>
							<tr>
								<td width="20%" style="text-align: right"><label for="select4">Course : </label></td>
		...
		<script>
			$(document).ready(function() {
				$('#batchselect').on('change', function() {
					...
					$.ajax({
						url: "/pages/html/common/common-get_class_schedules.php?course_id=" + course_id + "&batch_id=" + batch_id,
						type: "POST",
