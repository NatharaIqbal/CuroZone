...
<head>
	<meta charset="utf-8">
	<title>Add Class Schedules - CuroZone</title>
...
<div class="topbar">
	...
	<div class="side-bar">
		...
		<div class="menu">
			...
			<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-calendar"></i>Class Schedules
					<i class="fas fa-angle-right dropdown"></i>
				</a>
				<div class="sub-menu">
					<a class="sub-item" id="active-item">Add Class Schedules</a>
	...
	<div class="mainframe">
		<div class="welcome">
			<h2 style="text-align: center; padding: 5px;">Add Class Schedules</h2>
			<hr style="width: 50%; margin:auto;">
			<hr style="width: 50%; margin:auto;">
			<form id="form1" name="form1" method="post" action="coordinator-add_class_schedules_check.php">
				<table width="40%" class="filltbl">
					<tbody>
						...
						<tr>
							<td style="text-align: right"><label for="textfield4">Location</label></td>
							<td style="text-align: center">:</td>
							<td style="text-align: left"><input type="text" name="locationtxt" id="locationtxt"></td>
						</tr>
						<tr>
							<td style="text-align: right"><label for="date2">Date</label></td>
							<td style="text-align: center">:</td>
							<td style="text-align: left"><input type="date" name="datetxt" id="datetxt"></td>
						</tr>
						<tr>
							<td style="text-align: right"><label for="textfield4">Start Time</label></td>
							<td style="text-align: center">:</td>
							<td style="text-align: left"><input type="time" name="starttime" id="starttime"></td>
						</tr>
						<tr>
							<td style="text-align: right"><label for="textfield4">End Time</label></td>
							<td style="text-align: center">:</td>
							<td style="text-align: left"><input type="time" name="endtime" id="endtime"></td>
						</tr>
						<tr>
	...
	<script>
		$(document).ready(function() {
			$('#moduleselect').on('change', function() {
				...
				$.ajax({
					url: "/pages/html/common/common-get_lecturer.php",
					type: "POST",
					data: {
						module_id: module_id
					},
