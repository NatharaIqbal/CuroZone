...
<head>
	<meta charset="utf-8">
	<title>Manage Lecturers - CuroZone</title>
...
<div class="topbar">
	...
	<div class="mainframe">
		<div class="welcome">
			<h2 style="text-align: center; padding: 5px;">Manage Lecturers</h2>
		...
		<div class="task">
			<table width="100%" align="center">
				...
				<tbody>
					...
					$sql = "SELECT * FROM employee_tbl WHERE role='2'";
					...
					?>
						<tr>
							...
							<td>
								<?php echo "<form id='form1' name='form1' method='post' action='program_manager-edit_lecturer.php?employee_id=$row[employee_id]'>" ?>
	...
	<script>
		$(document).ready(function() {
			$('#departmentselect').on('change', function() {
				...
				$.ajax({
					url: "program_manager-filter_lecturer.php",
					type: "POST",
