...
<head>
	<meta charset="utf-8">
	<title>Final Results - CuroZone</title>
...
<body>
		...
		<div class="menu">
			...
			<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-line-chart"></i>Results
				...
				<div class="sub-menu">
					...
					<a id="active-item" class="sub-item">Final Results</a>
				</div>
			</div>
	...
	<div class="mainframe">
		<div class="welcome">
			<h2 style="text-align: center; padding: 5px;">Final Results</h2>
			...
			<form id="form1" name="form1" method="post">
				<table width="70%" border="0px" class="filltbl">
					<tbody>
						...
						<tr>
							<td colspan="7"><label for="select4">Student ID : </label>
	...
	<script>
		$(document).ready(function() {
			$('#batchselect').on('change', function() {
				...
				$.ajax({
					url: "program_manager-get_student.php",
					type: "POST",
					data: {
						batch_id: batch_id
					},
