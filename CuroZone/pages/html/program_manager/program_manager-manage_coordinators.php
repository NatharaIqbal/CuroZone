...
<head>
	<meta charset="utf-8">
	<title>Manage Coordinators - CuroZone</title>
...
<body>
		...
		<div class="menu">
			...
			<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-user"></i>Coordinators
				...
				<div class="sub-menu">
					...
					<a id="active-item" class="sub-item">Manage Coordinators</a>
				</div>
			</div>
	...
	<div class="mainframe">
		<div class="welcome">
			<h2 style="text-align: center; padding: 5px;">Manage Coordinators</h2>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td>
								<?php echo "<form id='form1' name='form1' method='post' action='program_manager-edit_coordinator.php?employee_id=$row[employee_id]'>" ?>
	...
	<script>
		$(document).ready(function() {
			$('#departmentselect').on('change', function() {
				...
				$.ajax({
					url: "program_manager-filter_coordinator.php",
					type: "POST",
