...
<div class="topbar">
	...
	<div class="side-bar">
		...
		<div class="menu">
			...
			<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-server"></i>Departments
				...
				<div class="sub-menu">
					<a id="active-item" class="sub-item">Add Departments</a>
	...
	<div class="mainframe">
		<div class="welcome">
			<h2 style="text-align: center; padding: 5px;">Add Departments</h2>
			<hr style="width: 50%; margin:auto;">
			<hr style="width: 50%; margin:auto;">
		</div>
		<div class="task">
			<form id="form1" name="form1" method="post" action="program_manager-add_department_check.php">
				<table id="table" width="40%">
					<tbody>
						...
						<tr>
							...
							<td width="57%" style="text-align: left"><input type="text" name="Ddepartmentidtxt" id="Ddepartmentidtxt" required></td>
						</tr>
						<tr>
							<td style="text-align: right"><label for="textfield2">Department Name</label></td>
							<td style="text-align: center">:</td>
							<td style="text-align: left"><input type="text" name="departmentnametxt" id="departmentnametxt" required></td>
						</tr>
