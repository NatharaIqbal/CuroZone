...
?>
    ...
    <body>
        ...
        <div class="mainframe">
            <div class="welcome">
                <h2 style="text-align: center; padding: 5px;">Add Module</h2>
            ...
            <div>
                <form id="form1" name="form1" method="post" action="program_manager-add_module_check.php">
                    <table width="60%" class="filltbl">
                        <tbody>
                            <tr>
                                ...
                                <td width="57%" style="text-align: left"><input type="text" name="moduleidtxt" id="moduleidtxt" required></td>
                            </tr>
                            <tr>
                                <td width="35%" style="text-align: right"><label for="textfield">Module Name</label></td>
                                <td style="text-align: center">:</td>
                                <td style="text-align: left"><input type="text" name="modulenametxt" id="modulenametxt" required></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="3" style="text-align: center; padding-top: 30px;"><input type="submit" name="submit" id="submit" value="Add"></td>
                            </tr>
                        </tbody>
                    </table>
                </form>
