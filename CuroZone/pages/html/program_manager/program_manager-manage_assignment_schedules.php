...
?>
	...
	<body>
			...
			<div class="menu">
				...
				<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-code"></i>Assignments
					...
					<div class="sub-menu">
						...
						<a id="active-item" class="sub-item">Manage Assignment Schedules</a>
					</div>
				</div>
		...
		<div class="mainframe">
			<div class="welcome">
				<h2 style="text-align: center; padding: 5px;">Manage Assignment Schedules</h2>
		...
		<script>
			$(document).ready(function() {
				$('#batchselect').on('change', function() {
					...
					$.ajax({
						url: "/pages/html/common/common-filter_assignment_schedules.php",
						type: "POST",
