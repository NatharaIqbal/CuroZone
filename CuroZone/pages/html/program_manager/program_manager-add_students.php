...
?>
	...
	<head>
		<meta charset="utf-8">
		<title>View Students - CuroZone</title>
	...
	<body>
		...
		<div class="mainframe">
			<div class="welcome">
				...
				?>
				<form id="form1" name="form1" method="post" action="program_manager-add_students_check.php">
					<table width="36%" class="filltbl">
						<tbody>
							<tr>
								...
								<td width="57%" style="text-align: left"><input type="text" name="studentidtxt" id="studentidtxt" required></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="text-align: right">
									<p><label for="textfield6">Last Name</label>
									</p>
								</td>
