...
<div class="topbar">
		...
		<div class="menu">
			...
			<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-pencil"></i>Exams
				...
				<div class="sub-menu">
					...
					<a id="active-item">Add Exam Schedules</a>
	...
	<div class="mainframe">
		<div class="welcome">
			<h2 style="text-align: center; padding: 5px;">Add Exam Schedules</h2>
			<hr style="width: 50%; margin:auto;">
			<hr style="width: 50%; margin:auto;">
		</div>
		<div class="task">
			<form id="form1" name="form1" method="post" action="program_manager-add_exam_schedules_check.php">
				<table id="table" width="40%">
					<tbody>
						...
						<tr>
							<td style="text-align: right"><label for="textfield6">Exam ID</label></td>
							<td style="text-align: center">:</td>
							<td style="text-align: left"><input type="text" name="examid" id="examid" required></td>
						</tr>
						<tr>
						...
						<tr>
							<td style="text-align: right"><label for="textfield6">Location</label></td>
							<td style="text-align: center">:</td>
							<td style="text-align: left"><input type="text" name="location" id="location" required></td>
						</tr>
						<tr>
							<td style="text-align: right"><label for="textfield4">Date</label></td>
							<td style="text-align: center">:</td>
							<td style="text-align: left"><input type="date" name="date" id="date" required></td>
						</tr>
						<tr>
							<td style="text-align: right"><label for="textfield4">Start Time</label></td>
							<td style="text-align: center">:</td>
							<td style="text-align: left"><input type="time" name="starttime" id="starttime" required></td>
						</tr>
						<tr>
							<td style="text-align: right"><label for="textfield4">End Time</label></td>
							<td style="text-align: center">:</td>
							<td style="text-align: left"><input type="time" name="endtime" id="endtime" required></td>
						</tr>
						<tr>
