...
<div class="topbar">
	...
	<div class="side-bar">
		...
		<div class="menu">
			...
			<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-pencil"></i>Exams
				...
				<div class="sub-menu">
					<a id="active-item" class="sub-item">Add Exams</a>
	...
	<div class="mainframe">
		<div class="welcome">
			<h2 style="text-align: center; padding: 5px;">Add Exams</h2>
		...
		<div class="task">
			<form id="form1" name="form1" method="post" action="program_manager-add_exams_check.php" enctype="multipart/form-data">
				<table width="40%">
					<tbody>
						<tr>
						...
						<tr>
							<td style="text-align: right"><label for="date2">Exam ID</label></td>
							<td style="text-align: center">:</td>
							<td style="text-align: left"><select id="examidselect" name="examidselect" required>
								</select></td>
						</tr>
						<tr>
							<td style="text-align: right"><label for="date2">File</label></td>
							<td style="text-align: center">:</td>
	...
	<script>
		$(document).ready(function() {
			$('#batchselect').on('change', function() {
				...
				$.ajax({
					url: "program_manager-get_exam.php",
					type: "POST",
					data: {
						batch_id: batch_id
					},
