...
<body>
    ...
    <div class="mainframe">
        <div class="welcome">
            <h2 style="text-align: center; padding: 5px;">Manage Modules</h2>
        ...
        <div class="task">
            <div class="noData">Select the <b>Department</b> and <b>Course</b></div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#courseselect').on('change', function() {
                ...
                console.log('task 2');
                $.ajax({
                    url: "/pages/html/common/common-filter_module.php",
                    type: "POST",
