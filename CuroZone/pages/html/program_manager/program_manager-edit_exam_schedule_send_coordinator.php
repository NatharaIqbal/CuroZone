...
<body>
    ...
    if ($status == '0') {
        $sql = "UPDATE exam_tbl SET send_schedule_coordinator = '1' WHERE exam_id = '" . $exam_id . "' AND batch_id = '" . $batch_id . "'";
        if (mysqli_query($con, $sql)) {
    ?>
            <div class="div1-1">
                <img src="/images/check.png" alt="Success image">
                <h1 class="success">Success!</h1>
                <h4>Exam schedule sent to coordinator.</h4>
    ...
    elseif($status == '1'){
        $sql = "UPDATE exam_tbl SET send_schedule_coordinator = '0' WHERE exam_id = '" . $exam_id . "' AND batch_id = '" . $batch_id . "'";
        if (mysqli_query($con, $sql)) {
    ?>
            <div class="div1-1">
                <img src="/images/check.png" alt="Success image">
                <h1 class="success">Success!</h1>
                <h4>Exam schedule unsent.</h4>
                <button onclick="location.href='/pages/html/program_manager/program_manager-manage_exam_schedules.php'" type="button">OK</button>
            </div>
        <?php
        } else {
