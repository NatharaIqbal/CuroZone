...
<body>
	...
	<div class="mainframe">
		<div class="welcome">
			<h2 style="text-align: center; padding: 5px;">Add Courses</h2>
			<hr style="width: 50%; margin:auto;">
			<hr style="width: 50%; margin:auto;">
		</div>
		<div class="task">
			<form id="form1" name="form1" method="post" action="program_manager-add_modules.php">
				<table id="table" width="60%">
					<tbody>
						<tr>
							<td width="35%" style="text-align: right"><label for="textfield">Course ID</label></td>
							<td width="8%" style="text-align: center">:</td>
							<td width="57%" style="text-align: left"><input type="text" name="courseidtxt" id="courseidtxt" required></td>
						</tr>
						<tr>
							<td style="text-align: right"><label for="textfield2">Course Name</label></td>
							<td style="text-align: center">:</td>
							<td style="text-align: left"><input type="text" name="coursenametxt" id="coursenametxt" required></td>
						</tr>
						<tr>
						...
						<tr>
							<td style="text-align: right"><label for="textfield3">Course Duration</label></td>
							<td style="text-align: center">:</td>
							<td style="text-align: left"><input type="text" name="durationtxt" id="durationtxt" required></td>
						</tr>
						<tr>
							<td style="text-align: right"><label for="textfield3">Start date</label></td>
							<td style="text-align: center">:</td>
							<td style="text-align: left"><input type="date" name="startdatetxt" id="startdatetxt" required></td>
						</tr>
						<tr>
							<td style="text-align: right"><label for="textfield4">Number of Modules</label></td>
							<td style="text-align: center">:</td>
							<td style="text-align: left"><input type="number" min="1" name="modulenumber" id="modulenumber" ></td>
						</tr>
						<tr>
