...
<head>
	<meta charset="utf-8">
	<title>Manage Courses - CuroZone</title>
...
<body>
		...
		<div class="menu">
			...
			<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-server"></i>Courses
				...
				<div class="sub-menu">
					...
					<a id="active-item" class="sub-item">Manage Courses</a>
	...
	<div class="mainframe">
		<div class="welcome">
			<h2 style="text-align: center; padding: 5px;">Manage Courses</h2>
			...
			<form id="form1" name="form1" method="post">
				<table class="searchtbl">
					<tbody>
						<tr>
							<td><label for="select">Department : </label><select name="departmentselect" id="departmentselect">
		...
		<div class="task">
		<div class="noData" style="padding: 40px;">Please select the Department.</div>
			</table>
		</div>
	</div>
	...
	<script>
		$(document).ready(function() {
			$('#departmentselect').on('change', function() {
				...
				$.ajax({
					url: "/pages/html/common/common-filter_course.php",
					type: "POST",
