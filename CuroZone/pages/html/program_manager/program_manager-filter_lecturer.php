...
if ($department_id  != '') {
    ...
    $sql = "SELECT * FROM employee_tbl WHERE department_id = '" . $department_id . "' AND role = '2'";
            ...
            ?>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <?php echo "<form id='form' name='form' method='post' action='program_manager-edit_lecturer.php?employee_id=$row[employee_id]'>" ?>
