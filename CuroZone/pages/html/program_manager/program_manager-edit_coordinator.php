...
<body>
    ...
    <div class="mainframe">
        ...
        <div class="back_btn">
            <a href="program_manager-manage_coordinators.php"><i class="fas fa-chevron-left"></i> Back</a>
        </div>

        <div class="welcome">
            <h2 style="text-align: center; padding: 5px;">Edit Coordinator Details</h2>
            <hr style="width: 50%; margin:auto;">
            <hr style="width: 50%; margin:auto;">
            <?php
            include('dbconnect.php');
            $_SESSION['employee_role'] = '1';
