...
?>
	...
	<head>
		<meta charset="utf-8">
		<title>Add Lecturers - CuroZone</title>
	...
	<body>
		...
		<div class="side-bar">
			...
			<div class="menu">
				...
				<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-user"></i>Lecturers
					...
					<div class="sub-menu">
						<a id="active-item" class="sub-item">Add Lecturers</a>
		...
		<div class="mainframe">
			<div class="welcome">
				<h2 style="text-align: center; padding: 5px;">Add Lecturers</h2>
				<hr style="width: 50%; margin:auto;">
				<hr style="width: 50%; margin:auto;">
				<?php
				include('dbconnect.php');
				?>
				<form id="form1" name="form1" method="post" action="program_manager-add_lecturer_check.php">
					<table width="40%" class="filltbl">
						<tbody>
							<tr>
								<td width="35%" style="text-align: right"><label for="textfield">Lecturer ID</label></td>
