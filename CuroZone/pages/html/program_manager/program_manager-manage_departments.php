...
<head>
	<meta charset="utf-8">
	<title>Manage Departments - CuroZone</title>
...
<div class="topbar">
		...
		<div class="menu">
			...
			<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-server"></i>Departments
				...
				<div class="sub-menu">
					...
					<a id="active-item" class="sub-item">Manage Departments</a>
				</div>
			</div>
	...
	<div class="mainframe">
		<div class="welcome">
			<h2 style="text-align: center; padding: 5px;">Manage Departments</h2>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<?php $department_id = $row['department_id'] ?>
							<td>
								<?php echo "<form id='form1' name='form1' method='post' action='program_manager-edit_departments.php?department_id=$department_id'>" ?>
								<button type="submit" value="<?php echo $department_id ?>" class="edit_btn" name="editbtn" id="editbtn">Edit</button>
								</form>
							</td>
							<td><button type="button" value="<?php echo $department_id ?>" class="confirm_del_btn" name="deletebtn" id="deletebtn">Delete</button></td>
						</tr>
					<?php
					}
